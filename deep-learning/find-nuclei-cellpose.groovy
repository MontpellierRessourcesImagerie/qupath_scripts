...
def cellpose = Cellpose2D.builder(pathModel)
        .pixelSize(0.3258)                  // Resolution for detection in um
        .channels('DAPI')	               // Select detection channel(s)
//        .tempDirectory( new File( '/home/benedetti/tmp/' ) ) // Temporary directory to export images to. defaults to 'cellpose-temp' inside the QuPath Project
